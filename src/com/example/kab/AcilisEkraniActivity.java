...
public class AcilisEkraniActivity extends Activity {
	 ...
	 *  ->setContentView(R.layout.activity_acilis_ekrani) => Ekranýn "activity_acilis_ekrani" layoutu ile doldurulmasýný saðlar. 
	 */
    @Override
    ...
    /** XML içerisinde onClick özelliði onKullanici olarak tanýmlanmýþ butonun kodlandýðý kýsýmdýr. 
     * 	Ekran referans alýnýr.
     * Sayfa geçiþinin yapýlabilmesi için ilgili sýnýf ile gidilecek sýnýf arasýndaki baðlantýnýn yapýldýðý intent yaratýlýr.
     * ve Activitiy yaratýlan intent referans verilerek baþlatýlýr.
     * */
    public void onKullanici(View v){
